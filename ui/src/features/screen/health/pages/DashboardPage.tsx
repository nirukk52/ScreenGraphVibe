        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">ScreenGraph</h1>
                <p className="text-gray-600">AI-driven crawling and verification system</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <h3 className="text-lg font-medium text-gray-900 mb-2">Agent Service</h3>
              <p className="text-sm text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <h3 className="text-lg font-medium text-gray-900 mb-2">Queue System</h3>
              <p className="text-sm text-gray-600">BullMQ and Redis queue processing status</p>
            </div>
          </div>
        </div>
      </main>
